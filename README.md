local reanimation = loadstring(game:HttpGet("https://gist.githubusercontent.com/BloxinStud10/f67a452dc43c281ca18c7b96cdba7075/raw/070f68a4b184c37245f23f42e54894e8e60b5007/xhQeOeaPUYYCNTqaUjQXjrGmh.lua"))()
local FDless = reanimation.start({
	...
	accessorylimbs={
		...
		{meshid="12410145311",textureid="12404371983",C0=CFrame.new(0,-0.75,0),Name="Head"},
		{meshid="12867814848",textureid="12794084950",C0=CFrame.new(-0.6,0.6,0),Name="Right Arm"},
		{meshid="12867814848",textureid="12794082919",C0=CFrame.new(0.6,0.6,0),Name="Left Arm"},
		{meshid="12867814848",textureid="12867900873",C0=CFrame.new(-0.1,0.92,0)*CFrame.Angles(0,-1.57,0),Name="Right Leg"},
		{meshid="12867814848",textureid="12867873138",C0=CFrame.new(0.1,0.92,0)*CFrame.Angles(0,1.57,0),Name="Left Leg"}
	},
	...
	debug = {
		...
		shownregions=false,
		addaccessories={12410453217,13244391424,12867908993,12867898930,12867846420,12867841874}
	}
	--[[
	    https://www.roblox.com/catalog/12410453217/Giants-Eye
	    https://www.roblox.com/catalog/13244391424/Big-Noob-Torso
    	https://www.roblox.com/catalog/12867908993/Black-Smiley-Rectangle-Head
...
local Spinny = FDless.getPartFromMesh(7535284433,7535284516)

local SpinnyWeld = FDless.getPartJoint(Spinny)

SpinnyWeld.Part1 = nil

local LScreen = FDless.getPartFromMesh(2309330801,2309333814)

local LScreenWeld = FDless.getPartJoint(LScreen)

LScreenWeld.Part1 = nil

local GetObjects = function(asset) assert(game.GetObjects,"Your executor is not supported! (missing GetObjects)") return game.GetObjects(game,asset) end
...
local script = GetInstanceFromScript("rbxassetid://4990034617","nsg","Script")
...
FHead = New("Part",char,"Derpz's Upper Shadow",{CanCollide = false,BrickColor = BrickColor.new("Really black"),Size = Vector3.new(1.20000005, 0.600000024, 1),CFrame = CFrame.new(68.5999985, 0.700013041, 9.89999962, 1, 0, 0, 0, 1, 0, 0, 0, 1),Color = Color3.new(0.0666667, 0.0666667, 0.0666667),})
...
sngy.Text = string.upper("Thiago's Glitcher")
sngy.TextSize = 24
sngy.Rotation = 0
...
scrg:Destroy()
 ...
 function newbosschatfunc(text,color,delay)
...
local Bruh=FXFolder.BossChat.NewDialog:Clone()
FDless.keepGui(Bruh)
Bruh.Parent=v.PlayerGui
local Bruh2=Bruh.H
game:GetService("Debris"):AddItem(Bruh,120)
--local scrg = Instance.new("ScreenGui",v.PlayerGui)
CFuncs["EchoSound"].Create("rbxassetid://525200869", Bruh, 0.5, 1,0,10,0.1,0.25,1)

--V bad code - salvo
Bruh2.BackgroundColor3=color
Bruh2.H1.BackgroundColor3=color
Bruh2.H12.BackgroundColor3=color
Bruh2.H13.BackgroundColor3=color
Bruh2.H14.BackgroundColor3=color
Bruh2.H1.BorderColor3=modet.TextStrokeColor3
Bruh2.H12.BorderColor3=modet.TextStrokeColor3
Bruh2.H13.BorderColor3=modet.TextStrokeColor3
Bruh2.H14.BorderColor3=modet.TextStrokeColor3
Bruh2.H.TextColor3=color
Bruh2.H.TextStrokeColor3=modet.TextStrokeColor3
Bruh2.H.BackgroundColor3=modet.TextStrokeColor3
Bruh2.H.H1.BackgroundColor3=modet.TextStrokeColor3
Bruh2.H.H2.BackgroundColor3=modet.TextStrokeColor3
Bruh2.H.H3.BackgroundColor3=modet.TextStrokeColor3
Bruh2.H.H4.BackgroundColor3=modet.TextStrokeColor3
Bruh2.H.H5.BackgroundColor3=modet.TextStrokeColor3
Bruh2.US.TextColor3=modet.TextStrokeColor3
Bruh2.US.TextStrokeColor3=color
Bruh2.PULSE.BackgroundColor3=modet.TextStrokeColor3

Bruh2.H.Text=text

Bruh2.US.Text=modet.Text

Bruh2:TweenPosition(UDim2.new(0,0,.5,0), "Out", "Quad", .2,true)

local dah=false
coroutine.resume(coroutine.create(function()
	for i = 1,string.len(text),1 do
		swait()
		Bruh2.H.Text = string.sub(text,1,i)
	end
end))
coroutine.resume(coroutine.create(function()
local mo1=1
...
local mo3=0
repeat
local t1,t2,t3,t4 = Bruh2.H1,Bruh2.H12,Bruh2.H13,Bruh2.H14
...
Bruh2.H1.BackgroundColor3=MAINRUINCOLOR.Color
...
Bruh2.H.H4.BackgroundColor3=SECONDRUINCOLOR.Color
Bruh2.H.H5.BackgroundColor3=SECONDRUINCOLOR.Color
...
ss:TweenSize(UDim2.new(0+(kan.PlaybackLoudness/820),0,0.8,0), "Out", "Quart", .2,true)
...
for i=50,delay do
swait()
Bruh2:TweenPosition(UDim2.new(0,0,.5+.02*math.cos((tick()*100) / 61),0), "Out", "Quad", .2,true)
...
local radm = math.random(1,3)
if radm == 1 then
bosschatfunc("ambatunat",MAINRUINCOLOR.Color,1)
elseif radm == 2 then
bosschatfunc("i might actually explode",MAINRUINCOLOR.Color,1)
elseif radm == 3 then
bosschatfunc("ambatubusindismouth oooooo",MAINRUINCOLOR.Color,1)
end
root.Anchored = true
...
wait(0.2)
local bc1 = workspace:WaitForChild("Thiago30K")["Body Colors"]:Clone()
bc1.Parent = obj1
local bc2 = workspace:WaitForChild("Thiago30K")["Body Colors"]:Clone()
bc2.Parent = Model0
shirt = Instance.new("Shirt", obj1)
shirt.Name = "Shirt"
pants = Instance.new("Pants", obj1)
pants.Name = "Pants"
obj1.Shirt.ShirtTemplate = workspace:WaitForChild("Thiago30K").Shirt.ShirtTemplate
obj1.Pants.PantsTemplate = workspace:WaitForChild("Thiago30K").Pants.PantsTemplate
shirt1 = Instance.new("Shirt", Model0)
shirt1.Name = "Shirt1"
pants1 = Instance.new("Pants", Model0)
pants1.Name = "Pants1"
Model0.Shirt1.ShirtTemplate = workspace:WaitForChild("Thiago30K").Shirt.ShirtTemplate
Model0.Pants1.PantsTemplate = workspace:WaitForChild("Thiago30K").Pants.PantsTemplate
local mesh1 = workspace:WaitForChild("Thiago30K").Head.Mesh:Clone()
mesh1.Parent = obj6
local mesh2 = workspace:WaitForChild("Thiago30K").Head.Mesh:Clone()
mesh2.Parent = Part5
local faz1 = workspace:WaitForChild("Thiago30K").Head.face:Clone()
faz1.Parent = obj6
local faz2 = workspace:WaitForChild("Thiago30K").Head.face:Clone()
faz2.Parent = Part5
end
--]]
...
if k == "0" and attack == false and ModeOfGlitch ~= Thiago30K then
ModeOfGlitch = Thiago30K
storehumanoidWS = 16
hum.WalkSpeed = 16
rainbowmode = true
chaosmode = false
CRAZED = false
Shadow = false
RecolorTextAndRename("Visualiser",Color3.new(0,0,0),Color3.new(1,1,1),"Code")
newTheme("rbxassetid://"..OVMID,0,OVMPIT,OVMVOL)
MAINRUINCOLOR = BrickColor.new("Really black")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end
if k == "m" and attack == false and ModeOfGlitch == 11 then
...
if k == "m" and attack == false and ModeOfGlitch == 666666999999666666 then
               ModeOfGlitch = 8
storehumanoidWS = 140
hum.WalkSpeed = 140
rainbowmode = false
...
if k == "m" and attack == false and ModeOfGlitch == 15 then
...
if k == "l" and attack == false and ModeOfGlitch ~= 10 then
               ModeOfGlitch = 10
storehumanoidWS = 10
hum.WalkSpeed = 10
rainbowmode = false
...
chaosmode = false
Shadow = false
RecolorTextAndRename("^v^",Color3.new(255,255,255),Color3.new(0,0,0),"Arcade")
...
if k == "semicolon" and attack == false and ModeOfGlitch == 2 and ModeOfGlitch ~= 4367677813 then
...
RecolorTextAndRename("SPEC-MAYHEM (SLOW PITCH)",Color3.new(1,1,0),Color3.new(0,0,0),"Bodoni")
kan.TimePosition = 0
...
kan.TimePosition = 0
newTheme("rbxassetid://147488802",0,1,8)
...
newbosschatfunc("THIAGO'S GLITCHER V8.2 LOADED",MAINRUINCOLOR.Color,200)
...
if ModeOfGlitch ~= 1264532489 and ModeOfGlitch ~= 8376532578634534 and ModeOfGlitch ~= Thiago30K and ModeOfGlitch ~= 55469696922 and ModeOfGlitch ~= 4367677813 and ModeOfGlitch ~= 9999999921111 and ModeOfGlitch ~= 999999999556 then
imgca.ImageTransparency = 1
elseif ModeOfGlitch == Thiago30K or ModeOfGlitch == 8376532578634534 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 9999999921111 or ModeOfGlitch == 999999999556 then
...
FDless.setCamOffset(hum.CameraOffset)
...
FDless.cframes[Spinny]=rotzo.CFrame
...
--------------- Visualiser Zone
if ModeOfGlitch == Thiago30K then
...
modet.TextColor3 = Color3.new(kan.PlaybackLoudness/1000,kan.PlaybackLoudness/1000,kan.PlaybackLoudness/1000)
RecolorTextAndRename("^v^",Color3.new(r/255,g/255,b/255),Color3.new(0,0,0),"Arcade")
MAINRUINCOLOR = BrickColor.new(r / 255, g / 255, b / 255)
...
handlex2weld.C0=clerp(handlex2weld.C0,cf(0,11,-1.5)*angles(math.rad(150 - 7 * math.cos(sine / 55)),math.rad(0 + 2 * math.cos(sine / 46)),math.rad(0 + 5 * math.cos(sine / 32))),.3)
...
FDless.cframes[LScreen] = Screen2.CFrame * angles(0,3.14,0)
...
elseif ModeOfGlitch == Thiago30K then
